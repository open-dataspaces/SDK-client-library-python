...
class TokenPasswordResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["access_token", "expires_in", "token_type", "not_before_policy", "scope", "refresh_token", "refresh_expires_in"]
