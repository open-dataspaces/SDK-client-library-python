...
class PostClientsResponse(BaseModel):
    ...
    PostClientsResponse
    """ # noqa: E501
    client_uuid: Optional[StrictStr] = None
    client_id: Optional[StrictStr] = None
    enabled: Optional[StrictBool] = None
    name: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    flow_type: Optional[StrictStr] = None
    open_system_id: Optional[StrictStr] = None
    operator_id: Optional[StrictStr] = None
    redirect_uris: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["client_uuid", "client_id", "enabled", "name", "description", "flow_type", "open_system_id", "operator_id", "redirect_uris"]
